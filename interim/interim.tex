...
\begin{figure*}[ht]
    ...
    \begin{tabular}{ |c|l|l| }
        ...
        \hline
        3
            & the propn ’ s abused by some most villainous knave , some base notorious knave , some scurvy fellow .
            & the propn is being tricked by some crook , some terrible villain , some rotten bastard . \\
        \hline
        4
        ...
        \hline
        8
            & then , if ever thou propn acknowledge it , i will make it my quarrel .
        ...
        10
            ...
            & i do n ’ t really want to do this , but he ’ s given me good reasons . \\
        \hline
        \end{tabular}}
    \caption{Sample Original-Modern Sentence Pairs, Processed (Without SOS/EOS Tokens)}
...
on the full merged dataset. % wrong
